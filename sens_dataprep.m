...
tOut=str2double(get_param(model, 'StartTime')):str2double(get_param(model, 'StopTime'));
...
try
 ParT=addprop(ParT,{'Kind','rMethod','Fixed','output','Vars','tout'},{'table','table','table','table','table','table'});
 ParT.Properties.CustomProperties.Kind=model;
